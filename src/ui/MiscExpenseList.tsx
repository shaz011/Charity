...
import { MiscExpense } from "../utils/types";
...
export function MiscExpenseList({ expenses, onEdit, onDelete }: MiscExpenseListProps): JSX.Element {
  ...
  return (
    <div style={{ border: "1px solid #ddd", borderRadius: 8, overflow: "hidden" }}>
      <div style={{ background: "#f7f7f7", padding: 16, borderBottom: "1px solid #ddd" }}>
        <h3 style={{ margin: 0, color: "#2c5aa0" }}>Miscellaneous Expenses</h3>
      ...
      <table style={{ width: "100%", borderCollapse: "collapse" }}>
        <thead style={{ background: "#f7f7f7" }}>
          <tr>
            <th style={{ textAlign: "left", padding: 8 }}>Expense Name</th>
